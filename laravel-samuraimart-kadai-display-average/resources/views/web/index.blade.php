        ...
        <div class="row">
          <div class="col-12">
            <p class="samuraimart-product-label mt-2">
              ...
              <span class="star-rating" style="--rating: {{ $recommend_product->reviews_avg_score ?? 0}}"></span>
              {{ number_format($recommend_product->reviews_avg_score ?? 0, 1 )}}<br>
        ...
        <div class="row">
          <div class="col-12">
            <p class="samuraimart-product-label mt-2">
              ...
              <span class="star-rating" style="--rating: {{ $recently_product->reviews_avg_score ?? 0}}"></span>
              {{ number_format($recently_product->reviews_avg_score ?? 0, 1 )}}<br>
